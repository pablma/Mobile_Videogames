...
import com.example.androidengine.Android_Graphics.Graphics;
import com.example.androidengine.Android_Input.Input;
...
public class Game extends Activity implements com.example.engine.Interfaces.Game {
    ...
    AndroidSurfaceView _renderView;
    Graphics _graphics;
    Input _input;
    State _state;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _renderView = new AndroidSurfaceView(this, frameBuffer);
        _graphics = new Graphics(getAssets(), frameBuffer);
        _input = new Input(_renderView, scaleX, scaleY);
