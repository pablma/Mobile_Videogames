...
public class LoadingState extends State {
    ...
    public void update(float deltaTime) {
        ...
        Assets._softBlueBackgroundRect  = new Rect(2 * (Assets._greenBlueBackgroundImg.getWidth() / 9),0,
        ...
        Assets._blueBackgroundRect  = new Rect(3 * (Assets._greenBlueBackgroundImg.getWidth() / 9),0,
        ...
        Assets._purpleBackgroundRect  = new Rect(4 * (Assets._greenBlueBackgroundImg.getWidth() / 9),0,
        ...
        Assets._darkBlueBackgroundRect  = new Rect(5 * (Assets._greenBlueBackgroundImg.getWidth() / 9),0,
                Assets._darkBlueBackgroundRect.getWidth() / 9, Assets._darkBlueBackgroundRect.getHeight());
        ...
        Assets._orangeBackgroundRect  = new Rect(6 * (Assets._greenBlueBackgroundImg.getWidth() / 9),0,
        ...
        Assets._redBackgroundRect  = new Rect(7 * (Assets._greenBlueBackgroundImg.getWidth() / 9),0,
        ...
        Assets._brownBackgroundRect  = new Rect(8 * (Assets._greenBlueBackgroundImg.getWidth() / 9),0,
        ...
        Assets._zeroRect  = new Rect(7 * (Assets._nineImg.getWidth() / 15),3 * (Assets._zeroImg.getHeight() / 7),
        ...
        Assets._oneRect  = new Rect(8 * (Assets._nineImg.getWidth() / 15),3 * (Assets._zeroImg.getHeight() / 7),
        ...
        Assets._twoRect  = new Rect(9 * (Assets._nineImg.getWidth() / 15),3 * (Assets._zeroImg.getHeight() / 7),
        ...
        Assets._threeRect  = new Rect(10 * (Assets._nineImg.getWidth() / 15),3 * (Assets._zeroImg.getHeight() / 7),
        ...
        Assets._fourRect  = new Rect(11 * (Assets._nineImg.getWidth() / 15),3 * (Assets._zeroImg.getHeight() / 7),
        ...
        Assets._fiveRect  = new Rect(12 * (Assets._nineImg.getWidth() / 15),3 * (Assets._zeroImg.getHeight() / 7),
        ...
        Assets._sixRect  = new Rect(13 * (Assets._nineImg.getWidth() / 15),3 * (Assets._zeroImg.getHeight() / 7),
        ...
        Assets._sevenRect  = new Rect(14 * (Assets._nineImg.getWidth() / 15),3 * (Assets._zeroImg.getHeight() / 7),
        ...
        Assets._eightRect  = new Rect(0,4 * (Assets._zeroImg.getHeight() / 7),
        ...
        Assets._nineRect  = new Rect((Assets._nineImg.getWidth() / 15),4 * (Assets._zeroImg.getHeight() / 7),
