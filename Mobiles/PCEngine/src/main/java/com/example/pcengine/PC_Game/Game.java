...
import com.example.pcengine.PC_Graphics.Graphics;
...
public class Game implements com.example.engine.Interfaces.Game {
    ...
    Graphics _graphics;
    com.example.pcengine.PC_Input.Input _input;
    State _state;
    ...
    public Game(String windowName, int w, int h){
        ...
        _graphics = new Graphics(_renderView);
        _input = new com.example.pcengine.PC_Input.Input(_renderView);
