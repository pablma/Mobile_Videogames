...
public class Graphics extends AbstractGraphics {
    ...
    public Image newImage(String name) {
       ...
       com.example.pcengine.PC_Graphics.Image img = new com.example.pcengine.PC_Graphics.Image(javaImage);
       return img;
    }
    ...
    protected void drawImagePrivate(Image image, Rect srcRect, Rect dstRect) {
        ...
        com.example.pcengine.PC_Graphics.Image img = (com.example.pcengine.PC_Graphics.Image)image;
